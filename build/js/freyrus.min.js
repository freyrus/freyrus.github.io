...
Pace.on("done",function(){$(".pace-progress").fadeOut("fast",function(){$(".wrapper-plus").fadeOut(400)})}),$(document).ready(function(){$("#fullpage").fullpage({verticalCentered:!0,resize:!0,sectionsColor:["#ccc","#fff"],anchors:["home","we-can-help","what-we-do","who-we-are","get-in-touch"],scrollingSpeed:700,easing:"easeInQuart",menu:!1,navigation:!1,navigationPosition:"right",navigationTooltips:["home","we-can-help","what-we-do","who-we-are","get-in-touch"],slidesNavigation:!0,slidesNavPosition:"bottom",loopBottom:!1,loopTop:!1,loopHorizontal:!0,autoScrolling:!0,scrollOverflow:!1,css3:!0,paddingTop:"0px",paddingBottom:"0px",normalScrollElements:"#element1, .element2",normalScrollElementTouchThreshold:5,keyboardScrolling:!0,touchSensitivity:15,continuousVertical:!1,animateAnchor:!0,sectionSelector:".section",slideSelector:".slide",keyboardScrolling:!0,scrollOverflow:!0,onLeave:function(e,a){$(".header__menu-item").removeClass("active"),$(".header__menu-item:eq("+(a-1)+")").addClass("active"),a>1?($(".back-to-top").fadeIn(400),$(".pages_hone-slogan_bg").removeClass("animated fadeInDown"),$(".pages_hone-slogan_content").removeClass("animated fadeInDown"),$("#wrapper-header-top").addClass("small-wapper fadeInUp animated"),setTimeout(function(){$("#wrapper-header-top").removeClass("animated fadeInDown fadeInUp")},1e3)):($(".back-to-top").fadeOut("400"),$("#wrapper-header-top").removeClass("small-wapper fadeInUp animated").addClass("fadeInDown animated"),$(".pages_hone-slogan_bg").addClass("animated fadeInDown hinge"),$(".pages_hone-slogan_content").addClass("animated fadeInDown hinge"),setTimeout(function(){$("#wrapper-header-top").removeClass("animated fadeInDown"),$(".pages_hone-slogan_bg").removeClass("animated fadeInDown"),$(".pages_hone-slogan_content").removeClass("animated fadeInDown")},1e3))},afterLoad:function(){},afterRender:function(){setTimeout(function(){$(".pages_hone-slogan_bg").removeClass("animated fadeInDown"),$(".pages_hone-slogan_content").removeClass("animated fadeInDown")},2e3)},afterResize:function(){},afterSlideLoad:function(){},onSlideLeave:function(){}});var e=$(".list-project-min a figure");e.hover(function(){$(this).addClass("figure_down");var e=$(this).parent();e.find(".project_name").stop().addClass("project_name_up"),e.find(".readMore").stop().slideDown("fast")},function(){$(this).removeClass("figure_down");var e=$(this).parent();e.find(".project_name").stop().removeClass("project_name_up"),e.find(".readMore").stop().slideUp("fast")}),$(".back-to-top").click(function(){return $.fn.fullpage.moveTo(1,0),!1})});